...
def time_based_weighted_average(dataframe, w1=28, w2=26, w3=24, w4=22):
 ...
 return dataframe.loc[df["day_diff"] <= df['day_diff'].min(), "overall"].mean() * w1 / 100 + \
...
###################################################
df["score_average_rating"] = (df['helpful_yes'] / (df['helpful_yes'] + df['helpful_no']) )#OLUMLU YORUMLAR BÖLÜ BÜTÜN YORUMLAR
